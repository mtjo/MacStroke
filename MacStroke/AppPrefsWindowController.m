...
+ (void)initialize {
    exampleAppleScripts = [NSArray arrayWithObjects:@"ChromeCloseTabsToTheRight", @"Close Tabs To The Right In Chrome",
                           @"OpenMacStrokePreferences", @"Open MacStroke Preferences",
...
- (void)setupToolbar {
    ...
    [self addView:self.rightClickPrefrenceView label:NSLocalizedString(@"RightClickMenu", nil) image:[NSImage imageNamed:@"RightClickMenu.png"]];
